...
class GlobalBase extends StatefulWidget {
  @override
  _GlobalBaseState createState() => _GlobalBaseState();
}

class _GlobalBaseState extends State<GlobalBase> {
  @override
...
{
    debugPrint("$e");
}    // debugPrint(globalData[i].toString()+"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"+globalData.length.toString());
                                    ...
                                    child: Column(
                                      ...
                                      children: <Widget>[
                                        ...
                                        AnimatedContainer(
                                          ...
                                          child: GestureDetector(child: Padbox("CNFMD",dataPayload[selectedRegion]["cases"],"[+"+dataPayload[selectedRegion]["todayCases"]+"]",Color.fromRGBO(2,131,255, 1),MediaQuery.of(context).size.height/10,MediaQuery.of(context).size.width/4.6),
                                          onTap: (){
                                            setState(() {
                                              cardX=0;
                                        ...
                                        AnimatedContainer(
                                          ...
                                          child: GestureDetector(child: Padbox("ACTV",dataPayload[selectedRegion]["active"],"",Color.fromRGBO(225, 0, 3, 1),MediaQuery.of(context).size.height/10,MediaQuery.of(context).size.width/4.6),
                                          onTap: (){
                                            setState(() {
                                              cardX=1;
                                        ...
                                        AnimatedContainer(
                                          ...
                                          child: GestureDetector(child: Padbox("RECVD",dataPayload[selectedRegion]["recovered"],"",Colors.green[700],MediaQuery.of(context).size.height/10,MediaQuery.of(context).size.width/4.6),
                                          onTap: (){
                                            setState(() {
                                              cardX=2;
                                        ...
                                        AnimatedContainer(
                                          ...
                                          child: GestureDetector(child: Padbox("DECSD",dataPayload[selectedRegion]["deaths"],"[+"+dataPayload[selectedRegion]["todayDeaths"]+"]",Colors.black87,MediaQuery.of(context).size.height/10,MediaQuery.of(context).size.width/4.6),
                                          onTap: (){
                                            setState(() {
                                              cardX=3;
                      ...
                      // left: mapPosition.dx,
                        child: Transform.scale(
                          ...
                          axis: Axis.horizontal,
                            child: GlobalHome(),
                            // child: ,
                            // childWhenDragging: Contain,                            
                            feedback: Container(
                              child:Center(child: Icon(FontAwesomeIcons.arrowsAlt))
                            ),
                            onDragEnd: (DraggableDetails drag){
                              setState(() {
                              // mapPosition=drag.offset;                          
                              }); 
                              debugPrint(drag.offset.toString());
                            },
                            ),
                        ),
                    )
