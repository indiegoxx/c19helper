...
part 'worldmap_svg_data.svg_path.g.dart';
...
Path getPathByProvince(Province province) {
  switch (province) {case Province.AE:
    return worldMapSvgData.AE;


  case Province.AF:
    return worldMapSvgData.AF;


  case Province.AL:
    return worldMapSvgData.AL;


  case Province.AM:
    return worldMapSvgData.AM;


  case Province.AO:
    return worldMapSvgData.AO;


  case Province.AR:
    return worldMapSvgData.AR;


  case Province.AT:
    return worldMapSvgData.AT;


  case Province.AU:
    return worldMapSvgData.AU;


  case Province.AZ:
    return worldMapSvgData.AZ;


  case Province.BA:
    return worldMapSvgData.BA;


  case Province.BD:
    return worldMapSvgData.BD;


  case Province.BE:
    return worldMapSvgData.BE;


  case Province.BF:
    return worldMapSvgData.BF;


  case Province.BG:
    return worldMapSvgData.BG;


  case Province.BI:
    return worldMapSvgData.BI;


  case Province.BJ:
    return worldMapSvgData.BJ;


  case Province.BN:
    return worldMapSvgData.BN;


  case Province.BO:
    return worldMapSvgData.BO;


  case Province.BR:
    return worldMapSvgData.BR;


  case Province.BS:
    return worldMapSvgData.BS;


  case Province.BT:
    return worldMapSvgData.BT;


  case Province.BW:
    return worldMapSvgData.BW;


  case Province.BY:
    return worldMapSvgData.BY;


  case Province.BZ:
    return worldMapSvgData.BZ;


  case Province.CA:
    return worldMapSvgData.CA;


  case Province.CD:
    return worldMapSvgData.CD;


  case Province.CF:
    return worldMapSvgData.CF;


  case Province.CG:
    return worldMapSvgData.CG;


  case Province.CH:
    return worldMapSvgData.CH;


  case Province.CI:
    return worldMapSvgData.CI;


  case Province.CL:
    return worldMapSvgData.CL;


  case Province.CM:
    return worldMapSvgData.CM;


  case Province.CN:
    return worldMapSvgData.CN;


  case Province.CO:
    return worldMapSvgData.CO;


  case Province.CR:
    return worldMapSvgData.CR;


  case Province.CU:
    return worldMapSvgData.CU;


  case Province.CY:
    return worldMapSvgData.CY;


  case Province.CZ:
    return worldMapSvgData.CZ;


  case Province.DE:
    return worldMapSvgData.DE;


  case Province.DJ:
    return worldMapSvgData.DJ;


  case Province.DK:
    return worldMapSvgData.DK;


  case Province.DO:
    return worldMapSvgData.DO;


  case Province.DZ:
    return worldMapSvgData.DZ;


  case Province.EC:
    return worldMapSvgData.EC;


  case Province.EE:
    return worldMapSvgData.EE;


  case Province.EG:
    return worldMapSvgData.EG;


  case Province.ER:
    return worldMapSvgData.ER;


  case Province.ES:
    return worldMapSvgData.ES;


  case Province.ET:
    return worldMapSvgData.ET;


  case Province.FK:
    return worldMapSvgData.FK;


  case Province.FI:
    return worldMapSvgData.FI;


  case Province.FJ:
    return worldMapSvgData.FJ;


  case Province.FR:
    return worldMapSvgData.FR;


  case Province.GA:
    return worldMapSvgData.GA;


  case Province.GB:
    return worldMapSvgData.GB;


  case Province.GE:
    return worldMapSvgData.GE;


  case Province.GF:
    return worldMapSvgData.GF;


  case Province.GH:
    return worldMapSvgData.GH;


  case Province.GL:
    return worldMapSvgData.GL;


  case Province.GM:
    return worldMapSvgData.GM;


  case Province.GN:
    return worldMapSvgData.GN;


  case Province.GQ:
    return worldMapSvgData.GQ;


  case Province.GR:
    return worldMapSvgData.GR;


  case Province.GT:
    return worldMapSvgData.GT;


  case Province.GW:
    return worldMapSvgData.GW;


  case Province.GY:
    return worldMapSvgData.GY;


  case Province.HN:
    return worldMapSvgData.HN;


  case Province.HR:
    return worldMapSvgData.HR;


  case Province.HT:
    return worldMapSvgData.HT;


  case Province.HU:
    return worldMapSvgData.HU;


  case Province.ID:
    return worldMapSvgData.ID;


  case Province.IE:
    return worldMapSvgData.IE;


  case Province.IL:
    return worldMapSvgData.IL;


  case Province.IN:
    return worldMapSvgData.IN;


  case Province.IQ:
    return worldMapSvgData.IQ;


  case Province.IR:
    return worldMapSvgData.IR;


  case Province.IS:
    return worldMapSvgData.IS;


  case Province.IT:
    return worldMapSvgData.IT;


  case Province.JM:
    return worldMapSvgData.JM;


  case Province.JO:
    return worldMapSvgData.JO;


  case Province.JP:
    return worldMapSvgData.JP;


  case Province.KE:
    return worldMapSvgData.KE;


  case Province.KG:
    return worldMapSvgData.KG;


  case Province.KH:
    return worldMapSvgData.KH;


  case Province.KP:
    return worldMapSvgData.KP;


  case Province.KR:
    return worldMapSvgData.KR;


  case Province.XK:
    return worldMapSvgData.XK;


  case Province.KW:
    return worldMapSvgData.KW;


  case Province.KZ:
    return worldMapSvgData.KZ;


  case Province.LA:
    return worldMapSvgData.LA;


  case Province.LB:
    return worldMapSvgData.LB;


  case Province.LK:
    return worldMapSvgData.LK;


  case Province.LR:
    return worldMapSvgData.LR;


  case Province.LS:
    return worldMapSvgData.LS;


  case Province.LT:
    return worldMapSvgData.LT;


  case Province.LU:
    return worldMapSvgData.LU;


  case Province.LV:
    return worldMapSvgData.LV;


  case Province.LY:
    return worldMapSvgData.LY;


  case Province.MA:
    return worldMapSvgData.MA;


  case Province.MD:
    return worldMapSvgData.MD;


  case Province.ME:
    return worldMapSvgData.ME;


  case Province.MG:
    return worldMapSvgData.MG;


  case Province.MK:
    return worldMapSvgData.MK;


  case Province.ML:
    return worldMapSvgData.ML;


  case Province.MM:
    return worldMapSvgData.MM;


  case Province.MN:
    return worldMapSvgData.MN;


  case Province.MR:
    return worldMapSvgData.MR;


  case Province.MW:
    return worldMapSvgData.MW;


  case Province.MX:
    return worldMapSvgData.MX;


  case Province.MY:
    return worldMapSvgData.MY;


  case Province.MZ:
    return worldMapSvgData.MZ;


  case Province.NA:
    return worldMapSvgData.NA;


  case Province.NC:
    return worldMapSvgData.NC;


  case Province.NE:
    return worldMapSvgData.NE;


  case Province.NG:
    return worldMapSvgData.NG;


  case Province.NI:
    return worldMapSvgData.NI;


  case Province.NL:
    return worldMapSvgData.NL;


  case Province.NO:
    return worldMapSvgData.NO;


  case Province.NP:
    return worldMapSvgData.NP;


  case Province.NZ:
    return worldMapSvgData.NZ;


  case Province.OM:
    return worldMapSvgData.OM;


  case Province.PA:
    return worldMapSvgData.PA;


  case Province.PE:
    return worldMapSvgData.PE;


  case Province.PG:
    return worldMapSvgData.PG;


  case Province.PH:
    return worldMapSvgData.PH;


  case Province.PL:
    return worldMapSvgData.PL;


  case Province.PK:
    return worldMapSvgData.PK;


  case Province.PR:
    return worldMapSvgData.PR;


  case Province.PS:
    return worldMapSvgData.PS;


  case Province.PT:
    return worldMapSvgData.PT;


  case Province.PY:
    return worldMapSvgData.PY;


  case Province.QA:
    return worldMapSvgData.QA;


  case Province.RO:
    return worldMapSvgData.RO;


  case Province.RS:
    return worldMapSvgData.RS;


  case Province.RU:
    return worldMapSvgData.RU;


  case Province.RW:
    return worldMapSvgData.RW;


  case Province.SA:
    return worldMapSvgData.SA;


  case Province.SB:
    return worldMapSvgData.SB;


  case Province.SD:
    return worldMapSvgData.SD;


  case Province.SE:
    return worldMapSvgData.SE;


  case Province.SI:
    return worldMapSvgData.SI;


  case Province.SJ:
    return worldMapSvgData.SJ;


  case Province.SK:
    return worldMapSvgData.SK;


  case Province.SL:
    return worldMapSvgData.SL;


  case Province.SN:
    return worldMapSvgData.SN;


  case Province.SO:
    return worldMapSvgData.SO;


  case Province.SR:
    return worldMapSvgData.SR;


  case Province.SS:
    return worldMapSvgData.SS;


  case Province.SV:
    return worldMapSvgData.SV;


  case Province.SY:
    return worldMapSvgData.SY;


  case Province.SZ:
    return worldMapSvgData.SZ;


  case Province.TD:
    return worldMapSvgData.TD;


  case Province.TF:
    return worldMapSvgData.TF;


  case Province.TG:
    return worldMapSvgData.TG;


  case Province.TH:
    return worldMapSvgData.TH;


  case Province.TJ:
    return worldMapSvgData.TJ;


  case Province.TL:
    return worldMapSvgData.TL;


  case Province.TM:
    return worldMapSvgData.TM;


  case Province.TN:
    return worldMapSvgData.TN;


  case Province.TR:
    return worldMapSvgData.TR;


  case Province.TT:
    return worldMapSvgData.TT;


  case Province.TW:
    return worldMapSvgData.TW;


  case Province.TZ:
    return worldMapSvgData.TZ;


  case Province.UA:
    return worldMapSvgData.UA;


  case Province.UG:
    return worldMapSvgData.UG;


  case Province.US:
    return worldMapSvgData.US;


  case Province.UY:
    return worldMapSvgData.UY;


  case Province.UZ:
    return worldMapSvgData.UZ;


  case Province.VE:
    return worldMapSvgData.VE;


  case Province.VN:
    return worldMapSvgData.VN;


  case Province.VU:
    return worldMapSvgData.VU;


  case Province.YE:
    return worldMapSvgData.YE;


  case Province.ZA:
    return worldMapSvgData.ZA;


  case Province.ZM:
    return worldMapSvgData.ZM;


  case Province.ZW:
  return worldMapSvgData.ZW;
  }
  return Path();
}
...
class worldMapSvgData {
  ...
  static double get width => 612.54211;
		...
		static Path get FI => _$worldMapSvgData_FI;		
		
		
		@SvgPath("M980.525,508.605l-0.348,1.396l-0.231,0.155l-1.782,0.716l-1.792,0.613l-0.36,-1.085l1.401,-0.596l0.889,-0.16l1.645,-0.905L980.525,508.605zM974.69,512.924l-1.274,-0.361l-1.082,1.004l0.271,1.288l1.546,0.363l1.738,-0.403l0.463,-1.529l-0.965,-0.843L974.69,512.924z")
		static Path get FJ => _$worldMapSvgData_FJ;		
		...
		static Path get XK => _$worldMapSvgData_XK;		
		
		
		@SvgPath("M609.767,375.756L610.352,377.174L610.101,377.905L611.004,380.309L609.021,380.391L608.323,378.875L605.825,378.567L607.882,375.487z")
		static Path get KW => _$worldMapSvgData_KW;		
